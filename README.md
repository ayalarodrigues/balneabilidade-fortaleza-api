...
| Francisco Eduardo Nogueira Nobre          | **Product Owner / Analista de Requisitos** | Acompanhou a definição do problema, ajudou a validar requisitos funcionais e não-funcionais e revisou se a solução atendia ao impacto social proposto. |
